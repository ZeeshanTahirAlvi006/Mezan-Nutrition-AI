        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-2.5 py-1">
              ...
              />
              <label className="text-xs md:text-sm text-on-surface-variant select-none cursor-pointer" htmlFor="remember">
          ...
          */}
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-on-surface-variant">
              ...
              <Link className="text-primary font-bold hover:underline ml-1.5" to="/register">
                Register
              </Link>
            </p>
          </div>
